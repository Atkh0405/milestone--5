...
(_a = document.getElementById("resumeForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", function (event) {
    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement && educationElement && experienceElement && skillsElement && usernameElement) {
        ...
        downloadLink.style.display = 'block'; // Add this to make the link visible
        ...
        if (resumeOutputElement) {
            ...
            downloadButton.addEventListener('click', function () {
                window.print(); // Open the print dialog allowing the user save as PDF.
            });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 3];
                        case 2:
                            alert("Name is required to generate shareable link.");
                            _a.label = 3;
            ...
            // Add the download link to the button container
